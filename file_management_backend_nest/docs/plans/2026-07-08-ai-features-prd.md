...
> 版本：v1.34  
> 日期：2026-07-08（S13～S19 更新见修订记录；**本批确认 F-30+搜图+查重：2026-07-20**；**F-40 整理文件夹远期：2026-07-20**；**F-30 ✅ 2026-07-21**；**F-38 ✅ 2026-07-21**；**F-39 ❌ 砍掉 2026-07-21**；**F-35 ✅ 完全重复查重 2026-07-21**；**F-24 设计：2026-07-21**；**里程碑修订：2026-07-22～23**；**F-41 文稿纠偏（不挡里程碑）：2026-07-23**）  
> 状态：执行中（… **视觉线收口**；**F-25 音频 ASR ✅**；**TTS MVP ✅**；**下一步：ai/ 目录重构 → 视频抽音轨**；**F-24 MCP 仍后置**；**F-41 文稿纠偏/手改 记需求、不插队**；**F-18 ⏸**；插件⏸；**更远：F-40 / F-20**）  
...
> AI 目录重构（下一步）：[2026-07-22-AI目录结构重构-里程碑.md](./2026-07-22-AI目录结构重构-里程碑.md)  
...
| **3′** | `ai/` 目录重构 | 只搬家、不改语义 | ⏳ **当前下一步**；见 [重构里程碑](./2026-07-22-AI目录结构重构-里程碑.md) |
| **4′** | 视频抽音轨 / 视频总结 | **F-25（视频）** | 重构完成后再开；复用已有 ASR |
...
**与更远期的关系：** F-40 / F-20 / F-23 / **F-41** 等仍在远期或里程碑后池。
...
> **下一批（🔜）：** 见 **§1.5**（**ai/ 目录重构** → 视频抽音轨）  
> **里程碑主线（修订后）：** 视觉收口 ✅ → **音频 ASR ✅** → **TTS ✅** → ai/ 重构 → 视频 → F-24 MCP  
> **其后视觉线：** F-31 → F-32 → F-33 → F-36 → F-37  
> **延后：** F-18；插件押后  
> **远期不排期：** F-40（AI 整理 B→C）、F-20（Agent）、F-21 / F-23、**F-41（文稿纠偏/手改，不挡里程碑）**  
> **已完成（本批及后续）：** F-30、**F-38**、**F-35（完全重复查重）**、**F-25 音频 ASR**、**TTS MVP**  
...
**下一批（🔜）：** `ai/` 目录重构 → F-25 视频抽音轨（见 §1.5）  
**其后：** F-24 MCP；F-31 → F-32 → F-33 → F-36 → F-37  
**远期不排期：** F-20 Agent、**F-40 AI 整理文件夹（B→C）**、F-21、F-23  
**已完成（含本批）：** F-05、F-06、F-07、F-11、F-08、F-26、F-27、F-29、**F-30**、**F-38**、**F-35（完全重复查重）**、**F-25 音频 ASR**、**TTS MVP**  
...
| [2026-07-22-AI目录结构重构-里程碑.md](./2026-07-22-AI目录结构重构-里程碑.md) | 下一步：ai/ 目录搬家 |

**下一步行动：** 视觉线已收口；**F-25 音频 ASR ✅**、**TTS MVP ✅**。下一步执行 [ai/ 目录重构](./2026-07-22-AI目录结构重构-里程碑.md)，完成后再开 **F-25 视频抽音轨**；其后 **F-24 MCP**。插件押后。**F-18** 延后至开放/上线前。
