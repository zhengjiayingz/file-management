...
### 1.3 下一阶段确认清单（2026-07-14 更新）

> **F-05 已于 2026-07-12 交付；F-06 已于 2026-07-14 交付。** 本批剩余 3 项如下。
...
| 2 | **F-07** | 知识库（多文档 RAG） | S16 | 7～10 天 | 🔜 **下一批 #2**；杀手级功能 |
| 3 | **F-11** | 划词翻译 | S16c | 0.5～1 天 | 🔜 **下一批 #3**；可穿插任意迭代 |
...
> **执行顺序：** 先完成 §1.3 本批（F-18 / F-07 / F-11），再按下列视觉线依次推进。
...
> **下一批（🔜）：** F-18 → F-07 → F-11（见 §1.3；F-05 / F-06 ✅ 已完成）  
...
**本批已完成：** F-05 PDF 索引（S14a）、**F-06 学术知识卡片（S14）**  
**本批后按需（P2 锦上添花）：** F-08、F-09、F-10  
**高价值高难度必做但排在地基后：** F-01～F-03 ✅、F-05 ✅、F-06 ✅；F-07 在本批；**F-26/F-30 为视觉地基**  
...
| W6～7 | 08-13～08-26 | **F-07**（S16） | 🔜 **知识库上线** |
...
**下一步行动：** F-05 / F-06 已交付。**按 §1.3 进入下一批：** 先做 **F-18 限流与 VIP（S15）**；随后 **F-07 知识库（S16）**；**F-11 划词翻译** 可在任意空档穿插。**§1.3 完成后按 §1.4 视觉线推进：** **F-26 → F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37**。
