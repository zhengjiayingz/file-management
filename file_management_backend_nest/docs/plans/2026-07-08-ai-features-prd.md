...
> 版本：v1.10  
> 日期：2026-07-08（S13 更新：2026-07-10；S14a F-05 完成：2026-07-12；**S14 F-06 完成：2026-07-14**；**S16 F-07 完成：2026-07-16**；**S16c F-11 完成：2026-07-16**；S18 视觉线排期：2026-07-14；**F-07 目录/重构约定：2026-07-14**）  
> 状态：执行中（S12 ✅、S13 F-03 ✅、**S14a F-05 ✅**、**S14 F-06 ✅**、**S16 F-07 ✅**、**S16c F-11 ✅**；**下一批：F-18**；**视觉线（S18）：F-26 → F-30 → F-27 → F-29…**）  
...
> **F-05 已于 2026-07-12 交付；F-06 已于 2026-07-14 交付；F-07 / F-11 已于 2026-07-16 交付。** 本批剩余 1 项如下。
...
> **执行顺序：** 先完成 §1.3 剩余项（**F-18**），再按下列视觉线依次推进。
...
> **下一批（🔜）：** F-18（见 §1.3；F-05 / F-06 / **F-07** / **F-11** ✅ 已完成）  
...
**本批已完成：** F-05 PDF 索引（S14a）、**F-06 学术知识卡片（S14）**、**F-07 知识库（S16）**、**F-11 划词翻译（S16c）**  
**本批后按需（P2 锦上添花）：** F-08、F-09、F-10  
**高价值高难度必做但排在地基后：** F-01～F-03 ✅、F-05 ✅、F-06 ✅、**F-07 ✅**、**F-11 ✅**；**F-26/F-30 为视觉地基**  
...
**下一步行动：** F-05 / F-06 / **F-07 / F-11 已交付**。**按 §1.3 进入下一批：** 做 **F-18 限流与 VIP（S15）**。**§1.3 完成后按 §1.4 视觉线推进：** **F-26 → F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37**。
