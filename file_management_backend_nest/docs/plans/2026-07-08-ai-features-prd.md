...
> 版本：v1.19  
> 日期：2026-07-08（S13 更新：2026-07-10；S14a F-05 完成：2026-07-12；**S14 F-06 完成：2026-07-14**；**S16 F-07 完成：2026-07-16**；**S16c F-11 完成：2026-07-16**；**S16b F-08 完成：2026-07-17**；**F-18 延后：2026-07-17**；S18 视觉线排期：2026-07-14；**F-07 目录/重构约定：2026-07-14**；**视觉 OCR/VL/CLIP 笔记：2026-07-17**；**下一批四件套确认：2026-07-18**；**F-26 增补 OCR 划词面板：2026-07-18**；**S18a F-26 完成：2026-07-18**；**F-27 产品约定：2026-07-18**）  
> 状态：执行中（S12 ✅、S13 F-03 ✅、**S14a F-05 ✅**、**S14 F-06 ✅**、**S16 F-07 ✅**、**S16c F-11 ✅**、**S16b F-08 ✅**、**S18a F-26 ✅**；**F-18 ⏸ 延后**；**下一批：F-27 → F-29 → F-30**；视觉线其余：F-31 → F-32 → F-33…）  
...
> **上一批已交付：** F-05（07-12）、F-06（07-14）、F-07 / F-11（07-16）、F-08（07-17）、**F-26（07-18）**。  
> **本批剩余（执行顺序，面试向）：F-27 → F-29 → F-30**。  
...
| 1 | **F-27** | **截图数学解题** | **S18c** | 3～4 天 | 🔜 **本批 #1**；MVP=网盘图；见 [F-27 约定](./2026-07-18-F27-截图数学解题-产品约定.md) |
| 2 | **F-29** | **错题本** | **S19** | 4～5 天 | 🔜 **本批 #2**；解题结果持久化 + 追问 |
| 3 | **F-30** | **扫描 PDF 可索引** | **S18b** | 3～5 天 | 🔜 **本批 #3**；无文字层 PDF 逐页 OCR（复用 F-26） |
...
| **本批 🔜** | 1 | **F-27** | 截图数学解题 | **S18c** | 3～4 天 | 🔜 独立 API + 流式；开放前建议补 **F-18** 限流（单人自用可暂不加） |
| | 2 | **F-29** | 错题本 | **S19** | 4～5 天 | 🔜 解题结果持久化 + 考点标签 + 二次追问 |
| | 3 | **F-30** | 扫描 PDF 可索引 | **S18b** | 3～5 天 | 🔜 无文字层 PDF 逐页渲染 + OCR；升级 F-05 |
...
|----|------|
| **优先级** | P1（视觉线 / **本批 #1**） |
| **状态** | 🔜 **本批 #1（S18c）**（2026-07-18：产品约定已对齐） |
| **价值** | 5 |
| **难度** | 3 |
| **代号** | S18c |
...
**技术方案**  
- `files-ai-math.service.ts` + `math-vision.provider.ts`  
- 模型：`AI_MATH_VISION_MODEL`（如 Qwen VL）；`streamText` 流式  
...
| **18** | **F-27** | **截图数学解题** | P1 | 5 | 3 | 3～4 天 | 🔜 **本批 #1**（S18c；开放前建议 F-18） |
| **19** | **F-29** | **错题本** | P2 | 5 | 3 | 4～5 天 | 🔜 **本批 #2**（S19） |
| **20** | **F-30** | **扫描 PDF 索引** | P1 | 5 | 3 | 3～5 天 | 🔜 **本批 #3**（S18b） |
...
**上一批已完成：** F-05、F-06、F-07、F-11、**F-08**、**F-26**  
**本批后按需：** F-09、F-10、F-19、F-12～F-13、F-25 等  
**高价值已交付：** F-01～F-03 ✅、F-05 ✅、F-06 ✅、**F-07 ✅**、**F-08 ✅**、**F-11 ✅**、**F-26 ✅**；本批剩余视觉三件套  
...
| W10 | 09-10～09-16 | **F-27**（S18c） | 🔜 **本批 #1** 截图数学解题 |
| W11 | 09-17～09-23 | **F-29**（S19） | 🔜 **本批 #2** 错题本 |
| W12 | 09-24～09-30 | **F-30**（S18b） | 🔜 **本批 #3** 扫描 PDF 索引 |
...
| [2026-07-18-F27-截图数学解题-实现方案.md](./2026-07-18-F27-截图数学解题-实现方案.md) | F-27 实现方案（待落地） |
| [2026-07-17-视觉-OCR-VL-CLIP-学习笔记.md](../knowledge/2026-07-17-视觉-OCR-VL-CLIP-学习笔记.md) | 视觉线入门：OCR vs VL vs CLIP |

**下一步行动：** 按 §1.3 **本批顺序**推进：**F-27 → F-29 → F-30**；其后视觉线 **F-31 → F-32 → F-33…**（仍标 🔜）。**F-18** 延后至开放给他人或上线前。
