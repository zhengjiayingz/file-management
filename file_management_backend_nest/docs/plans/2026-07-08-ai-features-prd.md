...
> 版本：v1.29  
> 日期：2026-07-08（S13～S19 更新见修订记录；**本批确认 F-30+搜图+查重：2026-07-20**；**F-40 整理文件夹远期：2026-07-20**；**F-30 ✅ 2026-07-21**；**F-38 ✅ 2026-07-21**；**F-24 设计：2026-07-21**；**里程碑四段：2026-07-21**）  
> 状态：执行中（… **S19 F-29 ✅**；**S18b F-30 ✅**；**S21a F-38 ✅**；**F-18 ⏸**；插件⏸；**下一批：F-39 → F-35**；**其后里程碑见 §1.5**；**更远：F-40 / F-20**）  
...
| **本批 🔜** | 3 | **F-39** | 以文搜图 | **S21b** | 1～2 天 | 🔜 文→图；与 F-08 同入口分区 |
...
| 段 | 内容 | ID / 范围 | 说明 |
|----|------|-----------|------|
| **1** | 图相关收尾 | **F-38 ✅ → F-39 → F-35** | 以图搜图已交付；剩余以文搜图、近似查重 |
...
| **22** | **F-39** | **以文搜图** | P1 | 5 | 2 | 1～2 天 | 🔜 **本批下一件** |
...
| **W14** | **08-04～08-10** | **F-39**（S21b）+ 搜索分区 | 🔜 **本批下一件** 以文搜图 + F-08 同入口 |
...
**下一步行动：** 按 [2026-07-20-多模态检索与查重-F30扫描PDF-实现方案.md](./2026-07-20-多模态检索与查重-F30扫描PDF-实现方案.md) 与 PRD §1.3 推进 **F-39 → F-35**。指纹与 RAG 分轨；插件押后。**F-18** 延后至开放/上线前。
