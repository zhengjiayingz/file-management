...
> 版本：v1.9  
> 日期：2026-07-08（S13 更新：2026-07-10；S14a F-05 完成：2026-07-12；**S14 F-06 完成：2026-07-14**；**S16 F-07 完成：2026-07-16**；S18 视觉线排期：2026-07-14；**F-07 目录/重构约定：2026-07-14**）  
> 状态：执行中（S12 ✅、S13 F-03 ✅、**S14a F-05 ✅**、**S14 F-06 ✅**、**S16 F-07 ✅**；**下一批：F-18 / F-11**；**视觉线（S18）：F-26 → F-30 → F-27 → F-29…**）  
...
### 1.3 下一阶段确认清单（2026-07-16 更新）

> **F-05 已于 2026-07-12 交付；F-06 已于 2026-07-14 交付；F-07 已于 2026-07-16 交付。** 本批剩余 2 项如下。

| 顺序 | ID | 功能 | 代号 | 建议工期 | 说明 |
|------|-----|------|------|----------|------|
| — | **F-05** | **PDF 文本索引** | **S14a** | 2～3 天 | ✅ **已完成**（2026-07-12） |
| — | **F-06** | **学术文献知识卡片** | **S14** | 5～7 天 | ✅ **已完成**（2026-07-14）；MVP=`paper`；`lab_report` 抽取见 F-06.1 |
| — | **F-07** | **知识库（多文档 RAG）** | **S16** | 7～10 天 | ✅ **已完成**（2026-07-16）；见 [F-07 学习笔记](./2026-07-14-F07-知识库-学习笔记.md) §交付记录 |
| 1 | **F-18** | AI 限流与 VIP 配额 | S15 | 2～3 天 | 🔜 **下一批 #1**；生产成本与 VIP 挂钩 |
| 2 | **F-11** | 划词翻译 | S16c | 0.5～1 天 | 🔜 **下一批 #2**；可穿插任意迭代 |

**本批不包含：** F-04 主题分析（与 F-03 `themes` 重叠，延后）、F-08～F-10 等 P2 锦上添花（待本批完成后按需排）。  
**F-06.1（非本批）：** `lab_report` 知识抽取、section-aware 分块加权（可选增强）。

### 1.4 视觉线确认清单（2026-07-14 更新）
...
> **执行顺序：** 先完成 §1.3 本批（F-18 / F-11），再按下列视觉线依次推进。

| 阶段 | 顺序 | ID | 功能 | 代号 | 建议工期 | 说明 |
|------|------|-----|------|------|----------|------|
| **P1 视觉地基+交互** | 1 | **F-26** | 图片可索引 | **S18a** | 2～3 天 | png/jpg/webp → OCR → 复用 chunk/embed/RAG/摘要 |
| | 2 | **F-30** | 扫描 PDF 可索引 | **S18b** | 3～5 天 | 无文字层 PDF 逐页渲染 + OCR；升级 F-05 |
| | 3 | **F-27** | 截图数学解题 | **S18c** | 3～4 天 | 独立 API + 流式；依赖 **F-18** 限流 |
| **P2 学习整理** | 4 | **F-29** | 错题本 | S19 | 4～5 天 | 解题结果持久化 + 考点标签 + 二次追问 |
| | 5 | **F-31** | 图片自动打标签 | S19b | 1～2 天 | 索引后 OCR/轻量 VL 抽关键词 → 标签建议 |
| | 6 | **F-32** | 手写笔记结构化 | S19c | 3～4 天 | 手写拍照 → OCR → 大纲 / Todo / Markdown |
| | 7 | **F-33** | 图表 / 公式图解读 | S19d | 2～3 天 | 对论文图、函数图做「这张图在说什么」 |
| **P3 锦上添花** | 8 | **F-35** | 重复截图去重 | S20 | 2～3 天 | 相似 OCR 文本 / hash，提示可能重复页 |
...
4. 前端图片预览：复用 `DocumentAiPanel`，支持「建立索引」  
...
> **下一批（🔜）：** F-18 → F-11（见 §1.3；F-05 / F-06 / **F-07** ✅ 已完成）  
> **视觉线（🔜）：** F-26 → F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37（见 §1.4）
...
| **7** | **F-18** | **AI 限流/VIP** | P1 | 4 | 2 | 2～3 天 | 🔜 **下一批 #1**（S15） |
| 8 | F-19 | CI/文章/简历 | P1 | 4 | 2 | 2～3 天 | S15 可选，非本批必做 |
| **9** | **F-07** | **知识库** | P1 | 5 | 4 | 7～10 天 | ✅ **S16 已完成**（2026-07-16） |
| 10 | F-08 | 语义搜索 | P2 | 4 | 2 | 2～3 天 | 本批后按需 |
| 11 | F-09 | 自动打标签 | P2 | 4 | 2 | 1～2 天 | 本批后按需 |
| 12 | F-10 | 分享 AI 摘要 | P2 | 4 | 2 | 1～2 天 | 本批后按需 |
| **13** | **F-11** | **划词翻译** | P1 | 3 | 1 | 0.5～1 天 | 🔜 **下一批 #2**（快速 win，可穿插） |
| 14 | F-12 | 版本对比 AI | P2 | 4 | 3 | 3～4 天 | S17 |
| 15 | F-13 | 文献对比矩阵 | P2 | 5 | 4 | 4～5 天 | S17 |
| 16 | F-25 | **视频/音频总结** | P2 | 5 | 4 | 7～10 天 | S17b，依赖 F-03 |
| **17** | **F-26** | **图片可索引** | P1 | 5 | 2 | 2～3 天 | 🔜 **视觉线 #1**（S18a） |
| **18** | **F-30** | **扫描 PDF 索引** | P1 | 5 | 3 | 3～5 天 | 🔜 **视觉线 #2**（S18b） |
| **19** | **F-27** | **截图数学解题** | P1 | 5 | 3 | 3～4 天 | 🔜 **视觉线 #3**（S18c，需 F-18） |
| **20** | **F-29** | **错题本** | P2 | 5 | 3 | 4～5 天 | 🔜 视觉线 #4（S19） |
| 21 | F-31 | 图片自动打标签 | P2 | 4 | 2 | 1～2 天 | 🔜 视觉线 #5（S19b） |
| 22 | F-32 | 手写笔记结构化 | P2 | 4 | 3 | 3～4 天 | 🔜 视觉线 #6（S19c） |
| 23 | F-33 | 图表/公式图解读 | P2 | 4 | 3 | 2～3 天 | 🔜 视觉线 #7（S19d） |
| 24 | F-15 | Hybrid 检索 | P3 | 3 | 3 | 3～4 天 | 按需 |
| 25 | F-14 | 闪卡生成 | P3 | 3 | 2 | 1～2 天 | 按需 |
| 26 | F-17 | 代码解释 | P3 | 3 | 1 | 0.5～1 天 | 顺手做 |
| 27 | F-35 | 重复截图去重 | P3 | 3 | 3 | 2～3 天 | 🔜 视觉线 #8（S20） |
| 28 | F-36 | 证件/敏感图提示 | P3 | 2 | 2 | 1～2 天 | 🔜 视觉线 #9（S20b） |
| 29 | F-37 | 分享页图片说明 | P3 | 3 | 2 | 1～2 天 | 🔜 视觉线 #10（S20c） |
...
**下一批（🔜）：** F-18 → F-11  
**视觉线（🔜）：** F-26 → F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37  
**本批已完成：** F-05 PDF 索引（S14a）、**F-06 学术知识卡片（S14）**、**F-07 知识库（S16）**  
**本批后按需（P2 锦上添花）：** F-08、F-09、F-10  
**高价值高难度必做但排在地基后：** F-01～F-03 ✅、F-05 ✅、F-06 ✅、**F-07 ✅**；**F-26/F-30 为视觉地基**  
**暂缓：** F-04 主题分析（与 F-03 `themes` 重叠）；**F-22 已合并至 F-26+F-30**；F-06.1（lab_report 抽取 / section-aware）
...
| W5 | 08-06～08-12 | **F-18**（S15） | 🔜 限流 + VIP 配额 |
| W6～7 | 08-13～08-26 | **F-07**（S16） | ✅ **知识库上线**（2026-07-16） |
| W7～8 | 08-20～09-02 | **F-11** | 🔜 划词翻译（可穿插 W5～7 空档） |
| W9 | 09-03～09-09 | **F-26**（S18a） | 🔜 图片 OCR 索引 |
| W10 | 09-10～09-16 | **F-30**（S18b） | 🔜 扫描 PDF 索引 |
| W11 | 09-17～09-23 | **F-27**（S18c） | 🔜 截图数学解题 |
| W12 | 09-24～09-30 | **F-29**（S19） | 🔜 错题本 |
| W13 | 10-01～10-07 | **F-31、F-32** | 🔜 图片标签 + 手写结构化 |
| W14 | 10-08～10-14 | **F-33** | 🔜 图表解读 |
| W15 | 10-15～10-21 | **F-35、F-36、F-37** | 🔜 视觉锦上添花 |
| W8+ | 穿插 | F-08～F-10、F-12～F-13、F-25 | 本批完成后按需 |
...
| [2026-07-12-F06-学术知识卡片-学习笔记与架构讨论.md](./2026-07-12-F06-学术知识卡片-学习笔记与架构讨论.md) | F-06 架构讨论（S14 ✅） |
| [2026-07-14-F07-知识库-学习笔记.md](./2026-07-14-F07-知识库-学习笔记.md) | F-07 架构讨论与交付记录（S16 ✅） |

**下一步行动：** F-05 / F-06 / **F-07 已交付**。**按 §1.3 进入下一批：** 先做 **F-18 限流与 VIP（S15）**；**F-11 划词翻译** 可在任意空档穿插。**§1.3 完成后按 §1.4 视觉线推进：** **F-26 → F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37**。
