...
> 版本：v1.11  
> 日期：2026-07-08（S13 更新：2026-07-10；S14a F-05 完成：2026-07-12；**S14 F-06 完成：2026-07-14**；**S16 F-07 完成：2026-07-16**；**S16c F-11 完成：2026-07-16**；**下一批确认：2026-07-16 → F-18 / F-08 / F-26**；S18 视觉线排期：2026-07-14；**F-07 目录/重构约定：2026-07-14**）  
> 状态：执行中（S12 ✅、S13 F-03 ✅、**S14a F-05 ✅**、**S14 F-06 ✅**、**S16 F-07 ✅**、**S16c F-11 ✅**；**下一批：F-18 → F-08 → F-26**；视觉线其余：F-30 → F-27 → F-29…）  
...
### 1.3 下一阶段确认清单（2026-07-16 再确认）

> **上一批已交付：** F-05（07-12）、F-06（07-14）、F-07 / F-11（07-16）。  
> **本批确认（执行顺序）：F-18 → F-08 → F-26。**
...
| 1 | **F-18** | **AI 限流与 VIP 配额** | **S15** | 2～3 天 | 🔜 **本批 #1**；生产成本与 VIP 挂钩；为后续 AI/视觉调用兜底 |
| 2 | **F-08** | **语义搜索** | **S16b** | 2～3 天 | 🔜 **本批 #2**；索引能力产品化出口（搜文件列表，非对话） |
| 3 | **F-26** | **图片可索引** | **S18a** | 2～3 天 | 🔜 **本批 #3**；视觉线地基（OCR → chunk/embed/RAG）；本批只开 F-26，**不含** F-30/F-27 |

**本批不包含：** F-04 主题分析（延后）、F-09/F-10、F-19（可选）、视觉线其余（F-30 起仍按 §1.4）。  
...
> **执行顺序：** §1.3 本批中的 **F-26** 作为视觉线起点；完成后继续 **F-30 → F-27 → F-29…**（F-27 仍建议先有 F-18）。
...
> **下一批（🔜）：** F-18 → F-08 → F-26（见 §1.3）  
> **视觉线（其余）：** F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37（F-26 已纳入本批）
...
| **17** | **F-26** | **图片可索引** | P1 | 5 | 2 | 2～3 天 | 🔜 **本批 #3**（S18a） |
| **18** | **F-30** | **扫描 PDF 索引** | P1 | 5 | 3 | 3～5 天 | 🔜 视觉线下一刀（S18b） |
| **19** | **F-27** | **截图数学解题** | P1 | 5 | 3 | 3～4 天 | 🔜 视觉线（S18c，需 F-18） |
...
**下一批（🔜）：** F-18 → F-08 → F-26  
**视觉线（F-26 之后）：** F-30 → F-27 → F-29 → F-31 → F-32 → F-33 → F-35 → F-36 → F-37  
**上一批已完成：** F-05、F-06、F-07、F-11  
**本批后按需：** F-09、F-10、F-19、F-12～F-13、F-25 等  
**高价值已交付：** F-01～F-03 ✅、F-05 ✅、F-06 ✅、**F-07 ✅**、**F-11 ✅**；本批开 **F-26** 视觉地基  
...
| W5 | 08-06～08-12 | **F-18**（S15） | 🔜 **本批 #1** 限流 + VIP |
| W6～7 | 08-13～08-26 | **F-07**（S16） | ✅ **知识库上线**（2026-07-16） |
| W7～8 | 08-20～09-02 | **F-11** | ✅ **划词翻译**（2026-07-16 提前交付） |
| — | 穿插 / 紧接 F-18 | **F-08**（S16b） | 🔜 **本批 #2** 语义搜索 |
| W9 | 09-03～09-09 | **F-26**（S18a） | 🔜 **本批 #3** 图片 OCR 索引 |
...
**下一步行动：** 按 §1.3 **本批顺序**推进：**F-18（限流/VIP）→ F-08（语义搜索）→ F-26（图片 OCR 索引）**。本批完成后继续视觉线 **F-30 → F-27 → F-29…**。
