...
> 版本：v1.20  
> 日期：2026-07-08（S13 更新：2026-07-10；S14a F-05 完成：2026-07-12；**S14 F-06 完成：2026-07-14**；**S16 F-07 完成：2026-07-16**；**S16c F-11 完成：2026-07-16**；**S16b F-08 完成：2026-07-17**；**F-18 延后：2026-07-17**；S18 视觉线排期：2026-07-14；**F-07 目录/重构约定：2026-07-14**；**视觉 OCR/VL/CLIP 笔记：2026-07-17**；**下一批四件套确认：2026-07-18**；**F-26 增补 OCR 划词面板：2026-07-18**；**S18a F-26 完成：2026-07-18**；**F-27 产品约定：2026-07-18**；**S18c F-27 完成：2026-07-19**）  
> 状态：执行中（S12 ✅、S13 F-03 ✅、**S14a F-05 ✅**、**S14 F-06 ✅**、**S16 F-07 ✅**、**S16c F-11 ✅**、**S16b F-08 ✅**、**S18a F-26 ✅**、**S18c F-27 ✅**；**F-18 ⏸ 延后**；**下一批：F-29 → F-30**；视觉线其余：F-31 → F-32 → F-33…）  
...
> **上一批已交付：** F-05（07-12）、F-06（07-14）、F-07 / F-11（07-16）、F-08（07-17）、**F-26（07-18）**、**F-27（07-19）**。  
> **本批剩余（执行顺序，面试向）：F-29 → F-30**。  
> **说明：** 相对视觉线「工程序」`F-26 → F-30 → F-27 → F-29`，本批按面试叙事优先 **先 OCR 地基 → VL 解题 → 错题本闭环 → 再补扫描 PDF**。若更偏工程完整度，可将 F-30 提前到 F-29 前。  
...
| 1 | **F-29** | **错题本** | **S19** | 4～5 天 | 🔜 **本批 #1**；解题结果持久化 + 追问 |
| 2 | **F-30** | **扫描 PDF 可索引** | **S18b** | 3～5 天 | 🔜 **本批 #2**；无文字层 PDF 逐页 OCR（复用 F-26） |
...
| **本批 🔜** | 1 | **F-29** | 错题本 | **S19** | 4～5 天 | 🔜 解题结果持久化 + 考点标签 + 二次追问 |
...
|----|------|
| **优先级** | P1（视觉线 / **本批 #3**） |
| **状态** | 🔜 **本批 #3（S18b）**（2026-07-18：纳入下一批；F-26 已交付） |
| **价值** | 5 |
| **难度** | 3 |
| **代号** | S18b |
| **依赖** | F-05、F-26 |
...
|----|------|
| **优先级** | P2（视觉线 / **本批 #2**） |
| **状态** | 🔜 **本批 #2（S19）**（2026-07-18：纳入下一批；F-26 已交付） |
| **价值** | 5 |
| **难度** | 3 |
| **代号** | S19 |
| **依赖** | F-27 |
...
**需求描述**  
F-27 解题后，用户可「存入错题本」：持久化题干、解答、可选考点标签与 **原题图**；支持列表浏览与对单题二次追问。
...
- **临时解题图（后续）**：依赖 F-27 约定的 `tempImageId` 中间态；点「加入」时转正落盘再写错题本（见 [F-27 产品约定](./2026-07-18-F27-截图数学解题-产品约定.md)）  
...
| **19** | **F-29** | **错题本** | P2 | 5 | 3 | 4～5 天 | 🔜 **本批 #1**（S19） |
| **20** | **F-30** | **扫描 PDF 索引** | P1 | 5 | 3 | 3～5 天 | 🔜 **本批 #2**（S18b） |
...
| W11 | 09-17～09-23 | **F-29**（S19） | 🔜 **本批 #1** 错题本 |
| W12 | 09-24～09-30 | **F-30**（S18b） | 🔜 **本批 #2** 扫描 PDF 索引 |
...
**下一步行动：** 按 §1.3 **本批顺序**推进：**F-29 → F-30**；其后视觉线 **F-31 → F-32 → F-33…**（仍标 🔜）。**F-18** 延后至开放给他人或上线前。
