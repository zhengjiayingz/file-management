...
import { toIndexMode } from '@/files/ai/summary/summary-genre.types';
...
import {
  ...
  type PaperKnowledge,
} from '@/files/ai/knowledge/knowledge.schemas';
import { buildFieldGroupPrompt } from '@/files/ai/knowledge/knowledge.prompt';
